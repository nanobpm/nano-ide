...
// user-task channel (`searchUserTasks` / `openUserTasks`). urban-testkit forwards
// the app's WASM engine, which satisfies the port, so the assignee/candidate-group
// narrowing and CREATED/COMPLETED semantics are unchanged.
