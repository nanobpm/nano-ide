...
import type { DemandPayload } from "@nanobpm/agentic-protocol";
import { correlateRegistry, type DiversityReport, type RegisteredWorker, type VocabResolver } from "@nanobpm/agentic-vocab";
